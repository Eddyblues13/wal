...
class SeedPhraseBloc extends Cubit<SeedPhraseState> {
  SeedPhraseBloc() : super(const SeedPhraseState());

  void generateSeedPhrase() {
    final words = _generateSecureSeedPhrase();
    emit(state.copyWith(seedPhrase: words));
  }
  ...
  void resetSeedPhrase() {
    emit(const SeedPhraseState());
  }

  List<String> _generateSecureSeedPhrase() {
    final wordList = [
      'abandon',
      'ability',
      'able',
    ...
    final random = List.generate(12, (index) {
      final randomIndex =
          (DateTime.now().millisecondsSinceEpoch + index) % wordList.length;
