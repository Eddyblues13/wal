...
class _DashboardState extends State<Dashboard> {
  final DashboardController _controller = DashboardController(context: context);
        ...
        return Card(
          ...
          child: Padding(
            ...
            child: Column(
              mainAxisAlignment: MainAxisAlignment.center,
              children: [
                Icon(stat.icon, size: 30.r, color: Colors.white),
                SizedBox(height: 8.h),
                Text(
                  stat.value,
                  style: TextStyle(
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            ...state.recentActivities.map((activity) => ListTile(
