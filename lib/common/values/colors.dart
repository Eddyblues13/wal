...
class AppColors {
  ...
  /// video background color (light grey instead of dark)
  static const Color primary_bg = Color(0xFFF5F5F5);
  ...
  /// light theme backgrounds (replacing dark)
  ...
  /// neutral UI tones
  static const arrowBox = Color(0xFFF2F2F2);
